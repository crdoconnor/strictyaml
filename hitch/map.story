...
Mapping - get item key not found:
  based on: Normal Map
  preconditions:
    code: |
...
Mapping - key not found in schema:
   based on: Normal Map
   preconditions:
     variables:
       invalid_sequence_1: |
